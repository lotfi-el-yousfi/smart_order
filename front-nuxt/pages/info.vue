          ...
          <div class="mt-10">
            <dl class="space-y-10 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10 md:space-y-0">
              <div class="relative">
                ...
                <NuxtLink v-if="getReleaseVersion() !== 'not available'"
              ...
              <div class="relative">
                ...
                <NuxtLink v-if="gitHash !== 'not available'"
                          :to="'https://github.com/jurassicjs/nuxt3-fullstack-tutorial/commit/'+ gitHash">
